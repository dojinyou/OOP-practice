package com.dojinyou.allfordev.refactoring.refactoring5;
...
public class Main {
  /*
    ...
    2. Store의 상품과 돈에 마음대로 접근할 수 있다.
      ...
      2. User의 결제 로직을 수정한다.
      3. User도 캡슐화 한다.
    3. User가 많은 행위를 책임지고 있다. Store가 판매하는 책임을 가질 수 있도록 한다.
      1. 상점에서 상품을 판매하는 행위를 추상화하고 구체적인 로직을 해당 메서드로 옮긴다.
    Todo: 4. 상품이 적절한 책임을 가져야 하지 않을까?
      1. Product가 Class를 가져야 한다.(data class)
   */
  public static void main(String[] args) {
    ...
    System.out.println("user의 잔돈 :" + user.getMoney());
